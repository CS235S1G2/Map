...
public:
	...
	bool isRed() { if (parentColor == RED) return true; else return false; };
	bool isBlack() { if (parentColor == BLACK) return true; else return false; };
	void setRed() { parentColor = RED; };
	void setBlack() { parentColor = BLACK; };
